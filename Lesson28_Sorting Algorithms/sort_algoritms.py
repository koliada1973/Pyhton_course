...
if __name__ == "__main__":
    ...
    for func in (bubble_sort, selection_sort, insertion_sort, shell_sort, merge_sort, quick_sort):
        ...
        # print(f'Відсортований список ({func.__name__}  {(end - start):.6f} sec.): {copy_test_list}')
        print(f'Відсортований список ({func.__name__}  {(end - start):.6f} sec.)')
